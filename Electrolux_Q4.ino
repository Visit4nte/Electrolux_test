...
ANSWER: To validate the message content is right it is possible use methods for error checking.
Some exemples of popular methods for it is: Parity BIT, CheckSum and CRC. 
This program uses the the parity BIT, simplest of those mentioned.

Q4_PT2) Now imagine that you receive a message and an interruption is triggered every time a new
